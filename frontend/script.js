...
recentlyPlayed.forEach((song) => {
  ...
  recentlyPlayedSongs.className =
    "card hp-subhero-card col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2";
...
const setTimeForGoodMorning = function () {
  ...
  if (myDate.getHours() < 12) {
    ...
    document.getElementById("good-morning-h3").innerHTML =
      "Good Evening!"; /* hour is in the evening */
  } else {
    document.getElementById("good-morning-h3").innerHTML =
      "I am so DUMB to calculate the current time!";
  }
};
