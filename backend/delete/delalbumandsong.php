...
<body>
  ...
  if (isset($_REQUEST['del']) and $_REQUEST['del'] != "") {
    ...
    $delete = new Albumandsong();
    $delete->songId = $id;
    $delete->flag = 1;
    $delete->updateAlbumandsong1();

    if ($delete->updateAlbumandsong1()) {
      ...
      <div class='ms-1'> <a href='/backend/Admin.php?page=addalbumandsong'class='btn btn-info mb-1 ml-2 mt-1' id=''>Back</a></div>";
