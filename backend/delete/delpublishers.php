...
<body>
  ...
  if (isset($_REQUEST['del']) and $_REQUEST['del'] != "" && isset($_REQUEST['name']) and $_REQUEST['name'] != "" ) {
    ...
    $delete->flag = 1;
    $delete->updatePublishers2();

    if ($delete->updatePublishers2()){
      ...
      <div class='ms-1'> <a href='/backend/Admin.php?page=addpublishers'class='btn btn-info mb-1 ml-2 mt-1' id=''>Back</a></div>";
