    ...
    <div class="row py-5">
        <div class="col-lg-12 mx-auto">
            <div class="p-5 rounded shadow "
                ...
                <h2 class="mb-5">Table Music Type</h2>
                ...
                <form  class="col-lg-8"name="get_Song" action="<?php echo $_SERVER['PHP_SELF'] ?>?page=listmusictype" method="POST" enctype="multipart/form-data">
...
//                            $stt = 1;
                            ...
                            for ($i = 0; $i < count($arr); $i++) {
                                ...
                                <tr scope='row'>
                                    ...
                                    <td> <?php echo $obj->musicTypeName ?></td>
                                    <td> <?php echo $obj->parentId ?></td>
                                    <td>  <img src="../backend/image/<?php echo $obj->picture ?>" width="60px"/></td>
                                    <td> <?php echo $obj->flag ?></td>
                                    <td> <?php echo $obj->description ?></td>
                                    <td>
                                        <div style='display:flex;'>
                                            <a href="Admin.php?page=addmusictype&id=<?php echo $obj->musicTypeId; ?>" class='btn btn-info mr-1' id='updatef'><i class='i bi-arrow-repeat'></i></a>
                                            <a href="../backend/delete/delsong.php?id=<?php echo $obj->musicTypeId; ?>&name=<?php echo  $obj->musicTypeName; ?>" class='btn btn-danger mr-1' id='deletef'><i class='bi bi-trash'></i></a>
                                        </div>
                                    </td>
                                </tr>                                            
                ...
                <div class="">
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-center">
                            <li class="page-item">
                                <a class="page-link" href="<?php echo $_SERVER['PHP_SELF'] ?>?page=listmusictype&<?php if ($page > 1) {
                                                                                                                echo 'pageno=' . ($page - 1);
                                                                                                            } ?>" aria-label="Previous">
                            ...
                            for ($pag = 1; $pag <= $total_pages; $pag++) { ?>
                                <li class="page-item"><a class="page-link" href="<?php echo $_SERVER['PHP_SELF'] ?>?page=listmusictype&<?php echo "pageno=$pag"; ?>"><?php echo $pag; ?></a></li>
                            <?php } ?>
                            <li class="page-item">
